...
if (!(Test-Path "C:\programdata\Microsoft OneDrive\OneDriveLib.dll"))
{
    ...
    Start-BitsTransfer 'https://raw.githubusercontent.com/rodneyviana/ODSyncService/master/Binaries/PowerShell/OneDriveLib.dll' -Destination 'C:\programdata\Microsoft OneDrive\'
}
...
{
    Write-Output "This must be executed under system user. Current one is $currentUser."
    break
}
